...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        init: function (el, options) {
            ...
            this._data.core.original_container_html
				...
				.remove();
            this.element.html("<" + "ul class='jstree-container-ul jstree-children' role='group'><" + "li id='j" + this._id + "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='tree-item'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("载入中 ...") + "</a></li></ul>");
        ...
        create_node: function (par, node, pos, callback, is_loaded) {
            ...
            if (!node) { node = { "text": this.get_string('新部门') }; }
            if (typeof node === "string") { node = { "text": node }; }
            if (node.text === undefined) { node.text = this.get_string('新部门'); }
            var tmp, dpc, i, j;
    ...
    $.jstree.plugins.contextmenu = function (options, parent) {
        ...
        this.show_contextmenu = function (obj, x, y, e) {
            ...
            //add by ywd 2016-11-3  根节点只保留新建按钮
            var copy = jQuery.extend({}, i);
            if (obj.parent == '#')
            {
                delete copy.ccp;
                delete copy.rename;
            ...
            if ($.isPlainObject(copy)) {
                this._show_contextmenu(obj, x, y, copy);
            }
        };
        /**
